...
<main class="contact-wrapper">
    ...
    if (isset($_SESSION['user'])) {
        echo '<p><a href="dashboard_contact.php#1" class="edit" target="_blank">Redigera</a></p>';
    ...
    if (isset($_SESSION['user'])) {
        echo '<p><a href="dashboard_contact.php#2" class="edit" target="_blank">Redigera</a></p>';
    }
    echo '</section>';
